...
<body>
    <h1 style="font-size: 60px;" class="font-iran-sans">خطای سرور !</h1>
    <h2 class="font-iran-sans">مشکلی در بارگذاری صفحه و یا در سرور وجود دارد ! این مشکل باید توسط ادمین سایت بر طرف شود. <b>:(</b></h2>
    <div class="gears">
        <div class="gear one">
            <div class="bar"></div>
            <div class="bar"></div>
