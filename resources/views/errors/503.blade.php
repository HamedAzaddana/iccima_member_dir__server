...
<body>
    <h1 style="font-size: 60px;" class="font-iran-sans">سایت در دست تعمیر است ! </h1>
    <h2 class="font-iran-sans"> بابت عدم دسترسی عذر می خواهیم. سایت برای اعمال یک سری به روزرسانی ها و بهبود ها در حال حاضر در دسترس نیست. <b>:(</b></h2>
    <div class="gears">
        <div class="gear one">
            <div class="bar"></div>
            <div class="bar"></div>
