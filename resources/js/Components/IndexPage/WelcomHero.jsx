            ...
            <section id="home" className="welcome-hero">
                ...
                <div className="container">
                    ...
                    <div className="welcome-hero-serch-box row">
                        <div className="col-md-12 col-lg-12 col-sm-12 InputS1" onClick={focusInputS1}>
                            <div style={{
                                width: "100%",
                                border: 0
                        ...
                        <div className="col-md-4 col-lg-4 col-sm-12 mt-4 InputS2">
                            <div style={{
                                width: "100%",
                                border: 0,
                        ...
                        <div className="col-md-4 col-lg-4 col-sm-12 mt-4 InputS3">
                            <button onClick={handleSearch} id='btn-do-search' ref={SubmitBtn} type="submit" className="form-control btn btn-danger"> جستجو <i className='fa fa-search'></i></button>
                        </div>
                    </div>
                </div>
            </section>
