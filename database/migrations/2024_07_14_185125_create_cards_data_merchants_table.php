...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('cards_data_merchants', function (Blueprint $table) {
            ...
            $table->text('companyname_en')->nullable();
            $table->text('companyname_fa')->nullable();
            ...
            $table->text('mainaddress_en')->nullable();
            $table->text('mainaddress_fa')->nullable();
            ...
            $table->text('sort_factor')->nullable();
